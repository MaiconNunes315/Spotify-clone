...
import { Rewind, SwitchHorizontal, HeartOutline,
    VolumeUpOutline, FastForward,Pause,Play,Reply,
VolumeUp } from "heroicons-react"
    ...
    return(
        ...
        grid grid-cols-3 text-xs md:text-base px-2 md:px-8">
            ...
            <div className="flex items-center space-x-3 md:space-x-4 justify-end pr-5">
                <VolumeUpOutline onClick={()=> volume > 0 && setVolume(volume-10)} className="button"/>
